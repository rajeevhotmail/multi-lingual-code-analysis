        ...
        if parameters:
            for param in parameters.children:
                if param.type == 'identifier':
                    ...
                    if param_name:  # Add null check
                        param_type = param.child_by_field_name('type')
                        if param_type:  # Add null check
                            params.append(f"{param_name.text.decode('utf8')}: {param_type.text.decode('utf8')}")
                    ...
                    params.append('*args' if param.type == 'list_splat_pattern' else '**kwargs')
